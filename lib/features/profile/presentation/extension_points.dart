...
/// Puntos de extensión de `profile` para features ajenas (hoy, solo
/// `voice`): vacíos por defecto, se completan una sola vez desde la
/// raíz de composición de la app (ver `main.dart`), que sí conoce todas
/// las features. `profile` nunca importa esas features directamente.
