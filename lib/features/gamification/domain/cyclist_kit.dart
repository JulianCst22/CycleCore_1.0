...
// `KitUnlockCondition`/`KitUnlockKind` viven en kit_unlock_condition.dart:
// son el motor de desbloqueos genérico que también usa `voice` para sus
// personas (ver voice_persona.dart) -- no son específicos del vestidor.
// Se re-exportan acá por comodidad del resto de la feature.
export 'kit_unlock_condition.dart';
